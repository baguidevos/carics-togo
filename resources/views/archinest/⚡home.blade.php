...
<div>
        ...
        <div class="auto-container">
            <div class="outer-box">
                <div class="row gap-2 justify-content-center">
                    ...
                    <x-archinest.service_block titre="Notre mission"
                        description="Produire des données probantes en santé publique et les transformer en actions concrètes afin d’améliorer durablement la santé des populations, en particulier les plus vulnérables.">
                    ...
                    <div class="counter-column-three">
                        <div class="inner-column">
                            <div class="content-box">
                                <div class="text text-reveal-anim">Nous intervenons principalement dans plusieurs
                            ...
                            <div class="row gx-2">
                                ...
                                <x-archinest.counter_card number="03" title="Santé communautaire">
                                    <br>
                                </x-archinest.counter_card>
                                <x-archinest.counter_card number="04"
                                    title=" Systèmes de santé et politiques publiques">
                                </x-archinest.counter_card>
                                <x-archinest.counter_card number="05" title="Suivi-évaluation des programmes de santé">
                                </x-archinest.counter_card>
                                <x-archinest.counter_card number="06"
                                    title="Innovation numérique et intelligence artificielle">
                                </x-archinest.counter_card>
            ...
            <div class="row">
                <div class="col-xl-8">
                    <div class="sec-title-style-three">
                        ...
                        <h2 class="title text-reveal-anim">Projet phare</h2>
                    </div>
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="pricing-block-two">
                                    <div class="d-flex gap-4 align-items-center flex-wrap mb-2 p-2">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span>Période: 2026-2027</span>
                                        </div>
                                        <div class="d-flex align-items-center gap-2">
                                            <span><i class="fa fa-location-arrow"></i></span>
                                            <span>Zone: Région des Savanes, Togo</span>
                                        </div>
                                        <div class="d-flex align-items-center gap-2">
                                            <span><i class="fa fa-info-circle"></i></span>
                                            <span>Statut: <span class="text-theme badge bg-success">En
                                                    cours</span></span>
                                        </div>
                                    ...
                                    <div class="inner-block">
                                        {{-- <div class="content-column">
                                            <div class="pricing-title"> Période : 2026-27</div>
                                            <div class="pricing-amount"> <span>Période: 2026-27</span></div>
                                            <div class="text">Zone D'intervention <br> Région des Savanes, Togo
                                        ...
                                        <div class="feature-box">
                                            <h3 class="pricing-title mb-3 h4">Renforcement de la mise en œuvre de la
                                                ChimioPrévention Saisonnière du Paludisme dans un contexte
                                                transfrontalier confronté à l'insécurité au Nord du Togo</h3>
                                            <p>
                                                Projet financé par la Royal Society of Tropical Medicine and Hygiene
                                                (RSTMH)
                                                visant à documenter les défis de mise en œuvre de la CPS dans la Région
                                                des
                                                Savanes et à produire des recommandations fondées sur les données
                                                probantes
                    ...
                    {{-- <div class="content-box">
                        <div class="count-outer">
                            <div class="count-box"><span class="count-text" data-speed="3000"
                                    data-stop="2026-2027">0</span><sup>+</sup></div>
                            <h4 class="count-text">Année</h4>
                        </div>
                        <div class="content">
                            <div class="text">We design meaningful spaces that blend creativity, innovation, &
                                timeless architectural excellence, creating environments that inspire and endure.
                            </div>
                            <a href="page-about.html" class="theme-btn btn-style-one">
                                <span class="btn-title"> See More About Us</span>
    ...
    <section class="funfact-section pt-0">
        <div class="large-container">
            <h1>Nos chiffres clés en 2026</h1>
                            ...
                            <div class="counter-block wow zoomIn" data-wow-delay="300ms">
                                <div class="inner">
                                    ...
                                    <div class="count-box style-two"><span class="count-text" data-speed="3000"
                                            data-stop="1">1</span></div>
                                    <h5 class="counter-title">Projet de recherche financé</h5>
                                </div>
                            </div>
                        </div>
    ...
    <section class="services-section-six">
        <div class="outer-box">
            <div class="sec-title-box">
                <div class="sec-title-style-three">
                    <h6 class="sub-title">// Architecture Services //</h6>
                    <h2 class="title text-reveal-anim">Our Expertise in Architecture & <br>Interior Design</h2>
                </div>
                <div class="btn-box">
                    <div class="text">We combine creativity, precision, and functionality to deliver architectural
                        designs that inspire &amp; endure.</div>
                    <a href="page-services.html" class="theme-btn btn-style-one">
        ...
        <div class="service-slide-wrapper position-relative">
            <div class="swiper-container service-active-h3">
                <div class="swiper-wrapper">
                    <!-- Service Block -->
                    <div class="service-block-six anim-fade-move swiper-slide" data-fade-from="right" data-delay="0.15">
                        <div class="inner-box">
                            <div class="number-box">
                                <div class="number">01</div>
                                <a class="btn-link-arrow" href="page-service-details.html">
                                    <img src="archinest/images/icons/icon-arrow-up1.png" alt="">
                                </a>
                            </div>
                            <div class="content-box text-center">
                                <h4 class="title"><a href="page-service-details.html">Commercial Design</a></h4>
                                <div class="text">Commercial</div>
                            </div>
                            <div class="image-box">
                                <div class="image">
                                    <a href="page-service-details.html">
                                        <img src="archinest/images/resource/service5-1.jpg" alt="">
                                        <img src="archinest/images/resource/service5-1.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="service-block-six anim-fade-move swiper-slide" data-fade-from="right" data-delay="0.15">
                        <div class="inner-box">
                            ...
                            <div class="content-box text-center">
                                <h4 class="title"><a href="page-service-details.html">Landscape Architecture</a>
                                </h4>
                            ...
                            <div class="image-box">
                                <div class="image">
                                    <a href="page-service-details.html">
                                        <img src="archinest/images/resource/service5-2.jpg" alt="">
                                        <img src="archinest/images/resource/service5-2.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="service-block-six anim-fade-move swiper-slide" data-fade-from="right" data-delay="0.15">
                        <div class="inner-box">
                            ...
                            <div class="content-box text-center">
                                <h4 class="title"><a href="page-service-details.html">Renovation & Remodeling</a>
                                </h4>
                                <div class="text">Renovation</div>
                            </div>
                            <div class="image-box">
                                <div class="image">
                                    <a href="page-service-details.html">
                                        <img src="archinest/images/resource/service5-3.jpg" alt="">
                                        <img src="archinest/images/resource/service5-3.jpg" alt="">
                                    </a>
                                </div>
                            </div>
            ...
            <div class="inner-container" style="background-image: url(archinest/images/background/bg-claint1-1.jpg);">
                <div class="outer-box">
                    ...
                    <p class="partenaire-content">
                        CARICS collabore avec les universités, instituts de recherche, ministères, ONG, agences de
                        développement et partenaires techniques et financiers souhaitant renforcer la production et
                        l'utilisation des données probantes en santé publique.
                    </p>
