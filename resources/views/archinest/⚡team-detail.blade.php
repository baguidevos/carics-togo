        ...
        <header class="hero-sm">
            <div class="container">
                <div class="row align-items-center g-4">
                    ...
                    <div class="col">
                        @if ($member['isFounder'])
                        <span class="badge-status light mb-2 d-inline-block">{{ __('team.detail.founder_badge') }}</span>
                        @endif
            ...
            <div class="container">
                <div class="row g-4 g-lg-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-5">
                            <div class="eyebrow">{{ __('team.detail.role_eyebrow') }}</div>
                            <h2 class="h4 mb-3">{{ __('team.detail.role_title', ['role' => $member['roleTitle']]) }}</h2>
                            <p>
                                {{ $member['missionText'] }}
                            </p>
                        </div>
                        ...
                        <div class="mb-5">
                            <div class="eyebrow">{{ __('team.detail.project_eyebrow') }}</div>
                            <h2 class="h4 mb-3">{{ __('team.detail.project_title') }}</h2>
                            <a href="{{ route('recherche-expertize-projet') }}" class="text-decoration-none text-reset">
                                <div class="project-highlight shadow-soft">
                                    <div class="ph-head" style="padding:1.4rem 1.6rem;">
                                        <div class="d-flex flex-wrap gap-2 align-items-center mb-2">
                                            <span class="badge-status ongoing">{{ __('team.detail.ongoing_badge') }}</span>
                                    ...
                                    <div class="ph-body" style="padding:1.2rem 1.6rem;">
                                        <span class="text-accent fw-semibold" style="font-size:.88rem;">{{ __('team.detail.project_link') }} <i class="fa fa-arrow-right ms-1"></i></span>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="sticky-lg-top" style="top:5.5rem;">
                            ...
                            <div class="card-soft mb-4" style="background:var(--bg-alt);">
                                <div class="eyebrow mb-3">{{ __('team.detail.expertises_eyebrow') }}</div>
                            ...
                            <div class="card-soft mb-4">
                                <div class="eyebrow mb-3">{{ __('team.detail.education_eyebrow') }}</div>
                            ...
                            <div class="card-soft mb-4" style="background:var(--bg-alt);">
                                <div class="eyebrow mb-3">{{ __('team.detail.affiliations_eyebrow') }}</div>
                                <ul class="list-unstyled mb-0" style="font-size:.88rem;">
                            ...
                            <!-- CONTACT / LIENS -->
                            <div class="card-soft">
                                <div class="eyebrow mb-3">{{ __('team.detail.links_eyebrow') }}</div>
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ $member['links']['googleScholar'] }}" class="share-btn" title="Google Scholar"><i class="fa-graduation-cap"></i></a>
                                    @endif
            ...
            <div class="container">
                <div class="d-flex flex-wrap justify-content-between align-items-end mb-4">
                    <div>
                        ...
                        <h2 class="section-title mb-0">{{ __('team.detail.other_members_title') }}</h2>
                    </div>
                    <a href="{{ route('equipe') }}" class="btn-cta-outline mt-3 mt-md-0">{{ __('team.detail.view_all_team') }} <i class="fa fa-arrow-right ms-1"></i></a>
                </div>
                <div class="row g-4">
                        ...
                        <a href="{{ route('team-detail', ['slug' => $other['slug']]) }}" class="text-decoration-none text-reset d-block h-100">
                            <div class="team-card h-100">
                                ...
                                <div class="team-body">
                                    ...
                                    <div class="team-link">{{ __('team.view_profile') }} <i class="fa fa-arrow-right ms-1"></i></div>
                                </div>
                            </div>
                        </a>
                    </div>
